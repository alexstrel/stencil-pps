...
int main() {
    auto ptr = std::make_shared<std::byte[]>(nbytes);
    //
    std::pmr::monotonic_buffer_resource resource_1(ptr.get(), nbytes);
    ...
    printf("vec4 (after resetting res1) %p %p\n", vec_4.data(), vec_4.end());
