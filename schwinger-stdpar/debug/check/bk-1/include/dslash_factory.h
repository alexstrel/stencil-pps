...
template<template <typename KernelArgs> class Kernel, typename KernelArgs, typename TransformParams>
class Mat{
  private:
  ...
  public:
    ...
    Mat(const KernelArgs &args, const TransformParams &param) : dslash_kernel_ptr(new Kernel<KernelArgs>(args)), 
	                                                        param(param) {}
