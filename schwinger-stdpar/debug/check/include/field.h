...
class FieldDescriptor {
  public: 
    ...
    FieldDescriptor(const FieldDescriptor &args, const FieldSiteSubset subset,  const FieldParity parity) : 
	    dir{subset == FieldSiteSubset::ParitySiteSubset and args.subset == FieldSiteSubset::FullSiteSubset ? args.dir[0] / 2 : args.dir[0], args.dir[1]},
	    order(args.order),
	    subset(subset),
	    parity(parity){}  
...
class Field{
  ...
  public:
    ...
    auto ExtAccessor() const {
       ...
       using StridedDyn4DView  = stdex::mdspan<data_tp, stdex::extents<dyn_indx_type, stdex::dynamic_extent, stdex::dynamic_extent, nDoF, nparity>, stdex::layout_stride>;

       return StridedDyn4DView(v.data(), Dyn4DMap{stdex::extents<dyn_indx_type, stdex::dynamic_extent, stdex::dynamic_extent, nDoF, nparity>{arg.dir[0], arg.dir[1]}, std::array<dyn_indx_type, 4>{1, arg.dir[0], arg.dir[0]*arg.dir[1], arg.dir[0]*arg.dir[1]*nDoF}}) ;
    }    
